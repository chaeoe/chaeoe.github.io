...
`one`은 막연한 지시어이고, `would`, `could`는 조동사로서 문법적·문체적 기능을 수행한다.
또한 `said`는 인물 간의 대화를 인용하는 상황에서 자주 등장하는 어휘일 뿐이며,
`even`은 주위의 내용을 강조하는 부사이다.

### 두 작품의 단어 빈도가 들려주는 이야기
- **공통으로 도드라지는 단어**: 두 작품 모두 `saw`, `found` 같은 어휘가 상위에 보인다.
이는 두 소설이 화자의 **시선과 발견**을 통해 공포감이나 긴장감을 쌓아가는 서술 방식을 공유하고 있다고 해석해 볼 수 있다.
